...
namespace CaliphAuctionBackend.Data;

public class CaliphDbContext(DbContextOptions<CaliphDbContext> options) : DbContext(options) {
	...
	public required DbSet<AuctionItemPurchase> AuctionItemPurchases {
		get;
		set;
	}
